...
enum Math {
    ...
    // Precomputed encode characters for faster access
    static let encodeCharacters: [Character] = {
        return Array("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz#$%*+,-.:;=?@[]^_{|}~")
    }()
}
